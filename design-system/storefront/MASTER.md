...
/* Primary Button */
.btn-primary {
  background: #EA580C;      /* --color-accent */
  color: #000000;           /* --color-on-accent -- white here is 3.56:1 and fails AA */
  padding: 12px 24px;
  border-radius: 8px;
  font-weight: 600;
...
```css
.card {
  background: #FFFFFF;      /* --color-card -- #ECFDF5 is --color-background, cards would vanish */
  border-radius: 12px;
  padding: 24px;
